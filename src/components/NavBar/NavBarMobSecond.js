...
function NavBarMob() {
    ...
    return (
        <>
            <div className='flex py-[0.9375rem] px-[0.9375rem] items-center justify-between'>
                <img src="https://new.axilthemes.com/themes/abstrak/wp-content/themes/abstrak/assets/images/logo/logo.svg" className=' w-[8.9375rem] h-auto' />
                ...
                <div className=' flex items-center'>
                    ...
                    <div className=" mr-[1.25rem]" >
                        <button className='btn-wrap bg-[#ecf2f6] w-[3.125rem] h-[3.125rem] flex flex-col justify-between' onClick={CheckSidePanel}>
                                ...
                                (
                                    <>
                                        <div className='sidepanelMob bg-white'>
                                            ...
                                            <div className='font-[500] text-[0.9375em] text-[#525260]'>
                    ...
                    <button className='  rounded-full text-white bg-[#5956e9] w-[3.125rem] h-[3.125rem]'>
                        <i class="fas fa-moon" />
                    </button>
