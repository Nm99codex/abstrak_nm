...
function NavBar() {
    ...
    return (
        <>
            ...
            <div className="flex sticky top-0 bg-white shadow-sm z-[9999] py-[0.9375rem]  px-[1.875rem] items-center justify-between">
                <img src="https://new.axilthemes.com/themes/abstrak/wp-content/themes/abstrak/assets/images/logo/logo-2.svg" />
                ...
                <div className=' flex items-center'>
                    ...
                    <div className="" >
                        <button className='btn-wrap bg-[#525260] w-[3.75rem] h-[3.75rem] flex flex-col justify-between' onClick={CheckSidePanel}>
                            <span className=' bg-white h-[2px] w-[1.25rem] mb-[0.25rem] rounded-[0.625rem] btn-wrap-span'></span>
                        ...
                        </button>
                        {
                            sidePanel ?
                                (
                                    <>
                                        <div className='sidepanel bg-white'>
                                            ...
                                            <div className=' bg-white flex items-center  p-[3.125rem] font-poppins pt-0'>
